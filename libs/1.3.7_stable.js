    ...
    class HRNGame extends HTMLElement {
        ...
        async loadGame() {
            ...
            if (!this.redirectblock) {
                sandbox.push("allow-popups", "allow-popups-to-escape-sandbox", "allow-top-navigation", "allow-top-navigation-by-user-activation");
            }
        ...
        render() {
            ...
            this.shadowRoot.innerHTML = `
                ...
                <div class="w" id="w">
                    ...
                    <div class="ov" id="ov">
                        <div class="sb">
                            <button class="cl" id="close" aria-label="Close game"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></button>
